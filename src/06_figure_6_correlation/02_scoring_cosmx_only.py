...
output_dir = input_dir / "cosmx_only"
...
print("\nLoading data...")
adata = sc.read_h5ad(input_dir / "cosmx_only_anndata.h5ad")
...
def compute_region_level_scores(adata):
    ...
    adata_t = adata[adata.obs["annotation"] == "T"]
    if adata_t.n_obs > 0:
    ...
    # B cells: EBV burden
    adata_b = adata[adata.obs["annotation"] == "B"]
    if adata_b.n_obs > 0:
