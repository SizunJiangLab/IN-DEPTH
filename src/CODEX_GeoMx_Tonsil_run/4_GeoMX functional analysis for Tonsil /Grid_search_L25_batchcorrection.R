...
#read data
mysegmentproperty <- read_excel(file.path(wdpath,"GeoMx_count_table/L25_GeoMXMeta.xlsx"),sheet = "SegmentProperties")
mycountmat <- read_excel(file.path(wdpath,"GeoMx_count_table/L25_GeoMXRawData.xlsx"),sheet = "BioProbeCountMatrix")
...
merged_table <- mysegmentproperty_mapped %>%
  full_join(summarized_data, by = c("ROILabel" = "ROI_indx", "Annotation7" = "Annotation7"))
...
SegmentMeta <- merged_table[,c("SegmentDisplayName","SegmentLabel","AOISurfaceArea","AOINucleiCount",
                               ...
                               "Annotation7","cell_count_CODEX", "median_cell_size" ,"median_dapi", "median_cd11b" ,"median_cd68" ,"median_cd11c",
...
# qsave(spe, file.path(wdpath,"GeoMX_L24_L25_batchcorrection/L25_spe_raw_counts.qs"))
...
Save.name_par <- file.path(wdpath,"GeoMX_L24_L25_batchcorrection","L25_para.csv")
# Save parameters
