---
title: "INDEPTH_check CellType and RNA for L25"
author: "Yuzhou"
...
spe_postcorrection_mat <- read.csv(file.path(wdpath,"GeoMX_L24_L25_batchcorrection/CPM-nNCG_2500-k_5_PostCorrectExp_L25.csv"),row.names = 1,check.names = F)
...
# qsave(Seurat_obj.out,file.path(wdpath,"GeoMx_count_table/L25_seurat_update.qs"))
```
